    ...
    <div className="min-h-screen flex items-center bg-gray-500 justify-center text-textPrimary transition-colors duration-300 p-4">
      <div className="bg-bgSecondary p-8 rounded-xl shadow-2xl w-full max-w-md border-2 border-gray-400">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900 dark:text-gray-700 tracking-tight mb-2">Selamat Datang</h1>
          <p className="text-sm font-medium text-textSecondary">Portal Manajemen Humas & Jaringan</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-textPrimary mb-2">Alamat Email</label>
            <input 
              type="email" 
              className="w-full bg-white border border-gray-200 dark:bg-bgPrimary dark:border-borderBase rounded-xl px-4 py-3 text-sm text-gray-900 dark:text-dark focus:outline-none focus:ring-2 focus:ring-indigo-500/50 dark:focus:ring-indigo-400/50 focus:border-indigo-500 transition-all placeholder-gray-400 dark:placeholder-gray-500"
          ...
          <div>
            <label className="block text-sm font-semibold text-textPrimary mb-2">Kata Sandi</label>
            <input 
              type="password" 
              className="w-full bg-white border border-gray-200 dark:bg-bgPrimary dark:border-borderBase rounded-xl px-4 py-3 text-sm text-gray-900 dark:text-dark focus:outline-none focus:ring-2 focus:ring-indigo-500/50 dark:focus:ring-indigo-400/50 focus:border-indigo-500 transition-all placeholder-gray-400 dark:placeholder-gray-500"
              placeholder="••••••••"
