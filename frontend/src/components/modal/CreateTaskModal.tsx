...
export function CreateTaskModal({ columnId, onClose }: CreateTaskModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        className="bg-bgPrimary w-full max-w-3xl max-h-[95vh] rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-black/[0.05] dark:border-white/[0.05] animate-in zoom-in-95 duration-200"
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className={`w-full bg-white border dark:bg-bgSecondary rounded-xl px-4 py-3 text-sm text-textPrimary min-h-[140px] focus:outline-none focus:ring-2 resize-none transition-all placeholder-textSecondary ${errors.description ? 'border-red-500 focus:border-red-500 focus:ring-red-200' : 'border-gray-200 dark:border-borderBase focus:border-gray-400 focus:ring-gray-200'}`}
                />
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-white border border-gray-200 dark:bg-bgSecondary dark:border-borderBase rounded-xl px-4 py-3 text-sm text-textPrimary focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400 transition-all cursor-pointer"
                >
                  <option value="high">High (Bobot 5)</option>
                  <option value="medium">Medium (Bobot 3)</option>
                  <option value="low">Low (Bobot 1)</option>
                </select>
              </div>
            </div>
